...
echo -e ""
echo -e " \e[1;32m- $bd Dropbear          $off    : $sdrop "
echo -e " \e[1;32m- $bd OpenSSH           $off    : $sssh "
echo -e " \e[1;32m- $bd Stunnel4          $off    : $sssl "
echo -e " \e[1;32m- $bd OpenVPN            $off   : $sovpn "
echo -e " \e[1;32m- $bd WebSocket Dropbear $off   : $swsdrop"
echo -e " \e[1;32m- $bd WebSocket OpenSSH   $off  : $swsopen"
echo -e " \e[1;32m- $bd WebSocket OpenVPN  $off   : $swsovpn"
echo -e " \e[1;32m- $bd WebSocket TLS    $off     : $swstls"
echo -e " \e[1;32m- $bd VMess TLS         $off    : $sv2ray "
echo -e " \e[1;32m- $bd VMess NON-TLS    $off     : $sv2none "
echo -e " \e[1;32m- $bd VLess TLS          $off   : $svless "
echo -e " \e[1;32m- $bd VLess NON-TLS      $off   : $svnone "
echo -e " \e[1;32m- $bd Shadowsocks       $off    : $sshadow "
echo -e " \e[1;32m- $bd Wireguard        $off     : $swg "
echo -e " \e[1;32m- $bd Trojan           $off     : $strojan "
echo -e " \e[1;32m- $bd IPSec           $off      : $sipsec "
echo -e " \e[1;32m- $bd SSR              $off     : $sssr "
echo -e " \e[1;32m- $bd SSTP            $off      : $ssstp "
echo -e " \e[1;32m- $bd PPTP              $off    : $spptp "
echo -e " \e[1;32m- $bd L2TP            $off      : $sl2tp"
echo -e " \e[1;32m- $bd Nginx          $off       : $snginx "
echo -e " \e[1;32m- $bd Squid           $off      : $ssquid "
echo -e " \e[1;32m- $bd Cron            $off      : $scron "
echo -e " \e[1;32m- $bd Fail2Ban        $off      : $sfail2ban "
echo -e " \e[1;32m- $bd VnStats         $off      : $svnstat "
echo -e " \e[1;32m- $bd SSLH            $off      : $sksslh "
echo -e ""
echo -e "${cyan}============-[ SERVICES STATUS ]-===========${off}"
echo -e ""
