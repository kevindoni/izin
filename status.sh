...
echo -e " - $bd Shadowsocks       $off    : $sshadow "
echo -e " - $bd Wireguard        $off     : $swg "
echo -e " - $bd Trojan           $off     : $strojan "
echo -e " - $bd IPSec           $off      : $sipsec "
echo -e " - $bd SSR              $off     : $sssr "
echo -e " - $bd SSTP            $off      : $ssstp "
echo -e " - $bd PPTP              $off    : $spptp "
echo -e " - $bd L2TP            $off      : $sl2tp"
