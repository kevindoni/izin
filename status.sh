...
echo -e " $mg - $bd WebSocket OpenVPN  $off   : $swsovpn"
echo -e " $mg - $bd WebSocket TLS    $off     : $swstls"
echo -e " $mg - $bd VMess TLS         $off    : $sv2ray "
echo -e " $mg - $bd VMess NON-TLS    $off     : $sv2none "
echo -e " $mg - $bd VLess TLS          $off   : $svless "
echo -e " $mg - $bd VLess NON-TLS      $off   : $svnone "
echo -e " $mg - $bd Shadowsocks       $off    : $sshadow "
echo -e " $mg - $bd Wireguard        $off     : $swg "
echo -e " $mg - $bd Trojan           $off     : $strojan "
echo -e " $mg - $bd IPSec           $off      : $sipsec "
echo -e " $mg - $bd SSR              $off     : $sssr "
echo -e " $mg - $bd SSTP            $off      : $ssstp "
echo -e " $mg - $bd PPTP              $off    : $spptp "
echo -e " $mg - $bd L2TP            $off      : $sl2tp"
echo -e " $mg - $bd Nginx          $off       : $snginx "
echo -e " $mg - $bd Squid           $off      : $ssquid "
echo -e " $mg - $bd Cron            $off      : $scron "
echo -e " $mg - $bd Fail2Ban        $off      : $sfail2ban "
echo -e " $mg - $bd VnStats         $off      : $svnstat "
echo -e " $mg - $bd SSLH            $off      : $sksslh "
echo -e ""
echo -e "${cyan}============-[ SERVICES STATUS ]-===========${off}"
echo -e ""
